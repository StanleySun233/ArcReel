...
export default {
  ...
  'session_expired': 'Authentication expired, please log in again',
  ...
  'credential_upload_failed': 'Failed to upload credentials',
  'source_content_load_failed': 'Failed to load file content',
  'source_file_save_failed': 'Failed to save file',
  'source_file_delete_failed': 'Failed to delete file',
  'draft_content_load_failed': 'Failed to load draft content',
  'draft_save_failed': 'Failed to save draft',
  'content_mode_immutable': 'content_mode cannot be changed after project creation',
  'upload_conflict_malformed': 'Failed to upload "{{filename}}": server returned 409 with incomplete detail fields',
