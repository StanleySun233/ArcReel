...
export default {
  ...
  'close_fullscreen_preview': 'Đóng xem trước toàn màn hình',
  'close_image_preview': 'Đóng xem trước ảnh',
  'image_fullscreen_preview': 'Xem trước toàn màn hình {{alt}}',
  'enlarge_image': 'Phóng to ảnh',
  'attachment_image': 'Ảnh đính kèm',
  'show': 'Hiển thị',
  'hide': 'Ẩn',
