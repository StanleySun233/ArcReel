...
export default {
  ...
  'session_expired': 'Phiên xác thực đã hết hạn, vui lòng đăng nhập lại',
  ...
  'credential_upload_failed': 'Tải thông tin xác thực lên thất bại',
  'source_content_load_failed': 'Không tải được nội dung tệp',
  'source_file_save_failed': 'Không lưu được tệp',
  'source_file_delete_failed': 'Không xóa được tệp',
  'draft_content_load_failed': 'Không tải được nội dung bản nháp',
  'draft_save_failed': 'Không lưu được bản nháp',
  'content_mode_immutable': 'Không thể thay đổi content_mode sau khi tạo dự án',
  'upload_conflict_malformed': 'Tải "{{filename}}" lên thất bại: máy chủ trả về 409 nhưng thiếu trường detail',
