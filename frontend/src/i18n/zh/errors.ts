...
export default {
  ...
  'import_failed': '导入失败',
  'upload_failed': '上传失败',
  'credential_upload_failed': '上传凭证失败',
  'source_content_load_failed': '获取文件内容失败',
  'source_file_save_failed': '保存文件失败',
  'source_file_delete_failed': '删除文件失败',
  'draft_content_load_failed': '获取草稿内容失败',
  'draft_save_failed': '保存草稿失败',
  'content_mode_immutable': '项目创建后不支持修改 content_mode',
  'upload_conflict_malformed': '上传 "{{filename}}" 失败：服务端返回 409 但 detail 字段不完整',
